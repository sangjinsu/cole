...
- [ ] Create Tauri + React + TypeScript project using Bun.
- [ ] Build `AppShell`, `VisualCanvas`, and `ChatComposer`.
- [ ] Add SQLite local database.
- [ ] Implement local task model.
- [ ] Implement Obsidian Markdown checklist parser.
- [ ] Render tasks as Focus / Next / Finish cards.
- [ ] Add OpenAI-compatible LLM adapter.
- [ ] Add AI recommendation schema validation.
- [ ] Add local done state.
